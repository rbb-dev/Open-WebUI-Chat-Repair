...
modules before ``open_webui_chat_repair`` is imported.
"""
...
users_module.User = DummyUser  # used by _lookup_user_ids_by_query
...
module_path = ROOT / "open-webui-chat-repair.py"
spec = importlib.util.spec_from_file_location("open_webui_chat_repair", module_path)
module = importlib.util.module_from_spec(spec)
assert spec and spec.loader, "Unable to create module spec for open-webui-chat-repair"
sys.modules.setdefault("open_webui_chat_repair", module)
